...
const ProtectedRoute: React.FC<ProtectedRouteProps> = ({ children, allowedRoles, requiredPermissions }) => {
  ...
  if (!isAuthenticated) {
    ...
    console.log('[ProtectedRoute] Passing state:', { from: location });
...
const AccessDenied: React.FC = () => (
  <div className="min-h-screen flex items-center justify-center bg-secondary-50">
    <div className="max-w-md w-full bg-white rounded-xl shadow-sm border border-secondary-200 p-8 text-center">
